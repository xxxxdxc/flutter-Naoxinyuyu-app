        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                '${state.activeUserName} · ${state.historySessions.length} 次采集',
                style: Theme.of(
                  context,
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text('暂无历史采集', style: Theme.of(context).textTheme.titleMedium),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _DetailRow(label: '设备', value: session.deviceName),
            _DetailRow(
              label: '开始时间',
